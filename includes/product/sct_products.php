                    ...
                    <div class="<?php echo $flex_format; ?>">
                        <a href="<?php echo $home.'pages/store/product.php?id='.$row['id'].'&title='.$row['product_name']; ?>" class="col g-8">
                            <figure class="img-box float-box">
                                ...
                                <a href="<?php echo $home.'functions/cart/fun_ins_cart.php?add='.$row['id']; ?>" title="Adicionar ao carrinho" class="float-button">
                        ...
                        <div class="pt-16">
                            ...
                            <div class="row g-8 py-8 ai-ce">
                                ...
                                <a href="<?php echo $home.'functions/cart/fun_ins_cart.php?add='.$row['id']; ?>" title="Adicionar ao carrinho" class="label-small">carrinho</a>
                            </div>
                        </div>
                    </div>
            <?php
