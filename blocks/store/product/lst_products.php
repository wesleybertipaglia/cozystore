<?php
    ...
    if(isset($_GET['query'])) {
        ...
        $subtitle = "";
        $paragraph = "";
        $query = "where product_name = '%".$_GET['query']."%'";
    }
    if(isset($_GET['category'])) {
        $category = "where product_cat = ".$_GET['category'];
    }
    if(isset($_GET['order'])) {
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="row g-8 py-8">
                                ...
                                <a href="<?php echo $home.'functions/store/cart/fun_ins_cart.php?id='.$row['id']; ?>" title="Adicionar ao carrinho">
